...
FTP_S = {"GPS_brdc": ["ftp://igs.gnsswhu.cn//pub/gps/data/daily/<YEAR>/<DOY>/<YY>n/brdc<DOY>0.<YY>n.gz",
         ...
         "MGEX_WHU_RTS_sp3": ["ftp://igs.gnsswhu.cn/pub/whu/phasebias/<YYYY>/orbit/"
                              "WUM0MGXRTS_<YYYY><DOY>0000_01D_01M_ORB.SP3.gz"],
         "GRE_GFZ_F_sp3": [
         ...
         "MGEX_IAC_F_sp3": ["ftp://igs.gnsswhu.cn/pub/gps/products/<GPSW>/IAC0MGXFIN_"
         ...
         "GRE_IGS_01S": [
             ...
             "--ftp-user anonymous --ftp-password cctcasm@163.com ftps://gdc.cddis.eosdis.nasa.gov/gnss/data/highrate/<YYYY>/<DOY>/<YY>d/<HOUR>/<SITE><DOY>a00.<YY>d.gz",
             "--ftp-user anonymous --ftp-password cctcasm@163.com ftps://gdc.cddis.eosdis.nasa.gov/gnss/data/highrate/<YYYY>/<DOY>/<YY>d/<HOUR>/<SITE><DOY>a15.<YY>d.gz",
             "--ftp-user anonymous --ftp-password cctcasm@163.com ftps://gdc.cddis.eosdis.nasa.gov/gnss/data/highrate/<YYYY>/<DOY>/<YY>d/<HOUR>/<SITE><DOY>a30.<YY>d.gz",
             "--ftp-user anonymous --ftp-password cctcasm@163.com ftps://gdc.cddis.eosdis.nasa.gov/gnss/data/highrate/<YYYY>/<DOY>/<YY>d/<HOUR>/<SITE><DOY>a45.<YY>d.gz",
         ],
         ...
         "GRE_USA_01S": [
             ' --header "Authorization: Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6Im80WDNMM1p0QkN6MmZ5RktMVW9mWiJ9..EbepJ0-qPb_IAq0WWhBPJYkAyY8itHqPAKdtNehRp8JSYVypIbn5wvPlE7xNpPl9cISk-cT5dVpvmUkKHlRRZ04YNNJqFw5AD9FKPs4BtKzlLgH-d8VTc5uLlOvqYlvCFeX_fWnZfP4vlntMsjobBGOlORy_HhuE7uJdt8F2sZltkhKylUgdN3ui0chRXOs9CriKRFmjhecROoKsHUrHG9IbvxQDUpU_0wecKJO1Qf7WSSIOM1vIirED8OP_wvgxSs8Smq04Nm_FfR3MPjFBLTDHLbRnpkyGENVf4yF27vl_njvGESprG4GtXtZriajwMmps_WTvIdUOxfScpLCCgg" https://data.unavco.org/archive/gnss/rinex/obs/<YYYY>/<DOY>/<SITE><DOY>0.<YY>d.Z'],
         ...
         "MGEX_WHU_RTS_clk": ["ftp://igs.gnsswhu.cn/pub/whu/phasebias/<YYYY>/clock/"
         ...
         "MGEX_CAS_R_osb": [
             "ftp://ftp.gipp.org.cn/product/dcb/daybias/<YEAR>/CAS0MGXRAP_<YYYY><DOY>0000_01D_01D_OSB.BIA.gz"],
         ...
         'GRACE_fo2_sp3': [
             'ftp://isdcftp.gfz-potsdam.de/grace-fo/ORBIT/L64/RSO/<YYYY>/<DOY>/GFZOP_RSO_L65_G_<YYYY_B><MONTH_B><DAY_B>_220000_<YYYY><MONTH><DAY>_120000_v02.sp3.gz',
